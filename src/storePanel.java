            ...
            while(!input5.equals("8")){
                ...
                switch(input5) {
                        ...
                        while(!input51.equals("8")){
                            ...
                            switch(input51) {
                                ...
                                case "5":
                                    ...
                                    gameUtil.executeSQLCommand(connection, "select * from game order by RANKING+0");
                                    //SQL statements
                                    break;
                                case "6":
                    ...
                    case "2":
                        ...
                        String vendorName = gameUtil.getStringValue(connection, "select vendor from game where sku= '"+skuInteger+"'");
                        ...
                        gameUtil.executeSQLCommand(connection, "select * from inventory where sku = '"+skuInteger+"' and storeid = '" + storeID +"'" );
                    ...
                    case "5":
                        ...
                        gameUtil.executeSQLCommand(connection,"select id,name,Username,Street,City,State,Phone,FrequentShopper from customer where username= '"+cashierPuttingCustEmail+"'");
                        break;
                    ...
                    case "6":
                        ...
                        gameUtil.executeSQLCommand(connection, "select id,Email,name,street,city,state,phone from vendor where name = '"+vendorNameInput + "'" );
                        break;
                    case "7":
                        ...
                        gameUtil.executeSQLCommand(connection, "update customer set frequentShopper = 'TRUE' where username = '"+ emailFreq+"'");
                        System.out.println("Enrollment Successful");
                        gameUtil.executeSQLCommand(connection, "select * from customer where username = '"+ emailFreq+"'");
                        break;
                }
            }
        } else {
